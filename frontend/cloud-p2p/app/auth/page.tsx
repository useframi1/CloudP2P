...
export default function AuthPage() {
  ...
  const { isAuthenticated, isLoading, error, signIn, signUp, clearError } = useAuthStore();
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 via-white to-gray-50 p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900">CloudP2P</h1>
            ...
            <Tabs defaultValue="signin" onValueChange={clearError}>
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signin-id">Client ID</Label>
                    <Input
                      id="signin-id"
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="signup-id">Client ID</Label>
                    <Input
                      id="signup-id"
